...
public class GameTree {
    ...
    int findValue() {
        ...
        findValueRecursive(root, true);

        return root.value;
    }

    public void findValueRecursive(TreeNode node, boolean isPlayerOne) {
        if (node.leaf) {
            return;
        }
        ...
        if (isPlayerOne) {
            ...
            for (TreeNode child : node.children) {
                findValueRecursive(child, false);
