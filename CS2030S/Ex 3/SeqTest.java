public class SeqTest {
  public static void main(String[] args) {
    ...
    i.expectCompile("cannot put a non-integer into an sequence of integer",
        "new Seq<Integer>(4).set(0, false)", false);

    i.expectCompile("cannot get a non-integer from an sequence of integer",
        "String s = new Seq<Integer>(4).get(0)", false);

    i.expectCompile("cannot create an sequence of non-comparable element", 
        "class A {} Seq<A> a;", false);

    i.expectCompile("cannot create an sequence of comparable element (but not to itself)", 
    ...
    i.expectCompile("can create an sequence of comparable element (to itself)", 
