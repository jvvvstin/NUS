...
class CS2030STest {
  ...
  public void expectCompileWithImport(String test, String statement,
      String importString, boolean success) {
    System.out.print(test);
    ...
    class JavaSourceFromString extends SimpleJavaFileObject {
      ...
      JavaSourceFromString(String code) {
        super(URI.create("string:///TempClass.java"), Kind.SOURCE);
        this.code = importString + " class TempClass {void foo(){" +  code + ";}}";
      }
